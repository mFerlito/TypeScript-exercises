...
function languagesSpoken(country: string, language1: string, language2?: string | undefined): void {
    //ho concatenato con or il type di undefined così da controllare l'eventuale caso in cui tale valore non sia definito
